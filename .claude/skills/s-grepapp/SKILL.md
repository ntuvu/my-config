...
name: s-grepapp
description: >-
  GitHub code search across 1M+ public repositories. Use when you need to see how real codebases implement a specific function, pattern, import, or API call. Triggers include requests like "show me how X is used in real projects", "find code examples of", "how do other repos implement", "find usages of", or any question where seeing actual source code patterns matters. Do NOT use for general web search, documentation lookup, or questions that don't need real code implementations from GitHub.
allowed-tools: Bash(bash $SKILL_DIR/scripts/grepapp.sh *)
---
